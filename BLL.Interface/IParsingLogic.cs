...
namespace BLL
{
    ...
    {
        bool AddShop(string shopName, string shopDiscount, string shopUrl, string shopImage, string dateAdd, string siteID, string shopLabel);
        bool AddSite(string siteName);
        IEnumerable<AbstractShop> GetShops();
        IEnumerable<Site> GetSites();
        IEnumerable<AbstractShop> GetShopsBySite(string siteID);
        IEnumerable<Site> GetSiteByID(string siteID);
